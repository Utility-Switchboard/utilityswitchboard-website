      ...
      <React.Fragment>
         ...
         <div className="content-hero-outer-container">
            <div className="content-hero-inner-container container-width">
               <span>
                  <h1>Switching guides<br/><span>TV & Broadband</span></h1>

                  <p>Switching broadband deal can save you £100s per year, and more importantly it's extremely quick and easy.</p>
         ...
         <div className="content-outer-container">
            <div className="content-inner-container container-width">
               <div className="content-container">
                  <Breadcrumbs location="tv-broadband/guides/switching"/>
...
export const Head: HeadFC = () => (
   <SEO
      metaDescription="Switching broadband deal can save you £100s per year, and more importantly it's extremely quick and easy."
      title="UK TV & Broadband switching guides"
      titleTemplate="%s - Utility Switchboard"
      slug="tv-broadband/guides/switching"
   />
)
