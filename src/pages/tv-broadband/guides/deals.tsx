      ...
      <React.Fragment>
         ...
         <div className="content-hero-outer-container">
            <div className="content-hero-inner-container container-width">
               <span>
                  <h1>Deals guides<br/><span>TV & Broadband</span></h1>

                  <p>Make sure you've got the best deal for your TV & Broadband this year and get clued up about what is on offer and where.</p>
         ...
         <div className="content-outer-container">
            <div className="content-inner-container container-width">
               <div className="content-container">
                  <Breadcrumbs location="tv-broadband/guides/deals"/>
...
export const Head: HeadFC = () => (
   <SEO
      metaDescription="Make sure you've got the best deal for your TV & Broadband this year and get clued up about what is on offer and where."
      title="UK TV & Broadband deals guides"
      titleTemplate="%s - Utility Switchboard"
      slug="tv-broadband/guides/deals"
   />
)
