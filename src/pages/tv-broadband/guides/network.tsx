      ...
      <React.Fragment>
         ...
         <div className="content-hero-outer-container">
            <div className="content-hero-inner-container container-width">
               <span>
                  <h1>Network guides<br/><span>TV & Broadband</span></h1>

                  <p>Broadband can be a complex topic when finding what exactly you need out of your internet deal. Become an expert here.</p>
         ...
         <div className="content-outer-container">
            <div className="content-inner-container container-width">
               <div className="content-container">
                  <Breadcrumbs location="tv-broadband/guides/network"/>
...
export const Head: HeadFC = () => (
   <SEO
      metaDescription="Broadband can be a complex topic when finding what exactly you need out of your internet deal. Become an expert here."
      title="UK TV & Broadband network guides"
      titleTemplate="%s - Utility Switchboard"
      slug="tv-broadband/guides/network"
   />
)
