      ...
      <React.Fragment>
         ...
         <div className="content-hero-outer-container">
            <div className="content-hero-inner-container container-width">
               <span>
                  <h1>Technical guides<br/><span>TV & Broadband</span></h1>

                  <p>Learn more about technical broadband vocabulary and concepts with our easy to understand guides.</p>
         ...
         <div className="content-outer-container">
            <div className="content-inner-container container-width">
               <div className="content-container">
                  <Breadcrumbs location="tv-broadband/guides/technical"/>
...
export const Head: HeadFC = () => (
   <SEO
      metaDescription="Learn more about technical broadband vocabulary and concepts with our easy to understand guides."
      title="UK TV & Broadband technical guides"
      titleTemplate="%s - Utility Switchboard"
      slug="tv-broadband/guides/technical"
   />
)
