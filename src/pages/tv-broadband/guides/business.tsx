      ...
      <React.Fragment>
         ...
         <div className="content-hero-outer-container">
            <div className="content-hero-inner-container container-width">
               <span>
                  <h1>Business guides<br/><span>TV & Broadband</span></h1>

                  <p>Read up about business broadband and how you can benefit from relief schemes, price reduction and plan switching.</p>
         ...
         <div className="content-outer-container">
            <div className="content-inner-container container-width">
               <div className="content-container">
                  <Breadcrumbs location="tv-broadband/guides/business"/>
...
export const Head: HeadFC = () => (
   <SEO
      metaDescription="Read up about business broadband and how you can benefit from relief schemes, price reduction and plan switching."
      title="UK TV & Broadband business guides"
      titleTemplate="%s - Utility Switchboard"
      slug="tv-broadband/guides/business"
   />
)
