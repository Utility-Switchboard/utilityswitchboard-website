...
const GasElectricityProviders = ({ data }: { data: pageProps }) => {
   const related_pages = data.allContentfulGasElectricityProviderMainPage.edges
      ...
      <React.Fragment>
         ...
         <div className="content-hero-outer-container">
            <div className="content-hero-inner-container container-width">
               <span>
                  <h1>Gas & electricity<br/><span>Providers</span></h1>

                  <p>Find your gas and electricity provider, or read up about a supplier that you'd like to switch to. Whatever your need, find it in the list below.</p>
         ...
         <div className="content-outer-container">
            <div className="content-inner-container container-width">
               <div className="content-container">
                  <Breadcrumbs location="gas-electricity/providers"/>
...
export default GasElectricityProviders
...
export const Head: HeadFC = () => (
   <SEO
      metaDescription="Find your gas and electricity provider, or read up about a supplier that you'd like to switch to. Whatever your need, find it in the list here"
      title="UK Gas & electricity providers"
      titleTemplate="%s - Utility Switchboard"
      slug="gas-electricity/providers"
   />
 )