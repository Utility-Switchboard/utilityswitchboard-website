...
const SwitchingGuides = ({ data }: { data: pageProps }) => {
      ...
      <React.Fragment>
         ...
         <div className="content-hero-outer-container">
            <div className="content-hero-inner-container container-width">
               <span>
                  <h1>Switching guides<br/><span>Gas & electricity</span></h1>

                  <p>Switching suppliers can save you large amounts of money. It's simple, quick and painless, but here's some guides to read up more.</p>
         ...
         <div className="content-outer-container">
            <div className="content-inner-container container-width">
               <div className="content-container">
                  <Breadcrumbs location="gas-electricity/guides/switching"/>
...
export default SwitchingGuides

export const Head: HeadFC = () => (
   <SEO
      metaDescription="Switching suppliers can save you large amounts of money. It's simple, quick and painless, but here's some guides to read up more."
      title="UK Gas & electricity switching guides"
      titleTemplate="%s - Utility Switchboard"
      slug="gas-electricity/guides/switching"
   />
)
