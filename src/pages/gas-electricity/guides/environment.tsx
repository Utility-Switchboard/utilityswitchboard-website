...
const EnvironmentGuides = ({ data }: { data: pageProps }) => {
      ...
      <React.Fragment>
         ...
         <div className="content-hero-outer-container">
            <div className="content-hero-inner-container container-width">
               <span>
                  <h1>Environment guides<br/><span>Gas & electricity</span></h1>

                  <p>Renewable energy is the future, find out more about how it affects our supply chain and your home specifically in the below guides.</p>
         ...
         <div className="content-outer-container">
            <div className="content-inner-container container-width">
               <div className="content-container">
                  <Breadcrumbs location="gas-electricity/guides/environment"/>
...
export default EnvironmentGuides

export const Head: HeadFC = () => (
   <SEO
      metaDescription="Renewable energy is the future, find out more about how it affects our supply chain and your home specifically in these guides."
      title="UK Gas & electricity environmental guides"
      titleTemplate="%s - Utility Switchboard"
      slug="gas-electricity/guides/environment"
   />
)
