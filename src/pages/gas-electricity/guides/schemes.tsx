...
const SchemesGuides = ({ data }: { data: pageProps }) => {
      ...
      <React.Fragment>
         ...
         <div className="content-hero-outer-container">
            <div className="content-hero-inner-container container-width">
               <span>
                  <h1>Schemes guides<br/><span>Gas & electricity</span></h1>

                  <p>Suppliers in co-operation with charities and the Government provide a variety of support packages to homes that need it most.</p>
         ...
         <div className="content-outer-container">
            <div className="content-inner-container container-width">
               <div className="content-container">
                  <Breadcrumbs location="gas-electricity/guides/schemes"/>
...
export default SchemesGuides

export const Head: HeadFC = () => (
   <SEO
      metaDescription="Suppliers in co-operation with charities and the Government provide a variety of support packages to homes that need it most."
      title="UK Gas & electricity schemes guides"
      titleTemplate="%s - Utility Switchboard"
      slug="gas-electricity/guides/schemes"
   />
)
