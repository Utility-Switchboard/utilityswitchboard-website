...
const MetersGuides = ({ data }: { data: pageProps }) => {
      ...
      <React.Fragment>
         ...
         <div className="content-hero-outer-container">
            <div className="content-hero-inner-container container-width">
               <span>
                  <h1>Meter guides<br/><span>Gas & electricity</span></h1>

                  <p>There are variety of meter types in the UK which can get rather complicated. Read up here and master yours.</p>
         ...
         <div className="content-outer-container">
            <div className="content-inner-container container-width">
               <div className="content-container">
                  <Breadcrumbs location="gas-electricity/guides/meters"/>
...
export default MetersGuides

export const Head: HeadFC = () => (
   <SEO
      metaDescription="There are variety of meter types in the UK which can get rather complicated. Read up here and master yours."
      title="UK Gas & electricity meter guides"
      titleTemplate="%s - Utility Switchboard"
      slug="gas-electricity/guides/meters"
   />
)
