...
const BusinessGuides = ({ data }: { data: pageProps }) => {
      ...
      <React.Fragment>
         ...
         <div className="content-hero-outer-container">
            <div className="content-hero-inner-container container-width">
               <span>
                  <h1>Business guides<br/><span>Gas & electricity</span></h1>

                  <p>Read up about business energy and how you can benefit from relief schemes, energy reduction and tariff switching.</p>
         ...
         <div className="content-outer-container">
            <div className="content-inner-container container-width">
               <div className="content-container">
                  <Breadcrumbs location="gas-electricity/guides/business"/>
...
export const Head: HeadFC = () => (
   <SEO
      metaDescription="Read up about business energy and how you can benefit from relief schemes, energy reduction and tariff switching."
      title="UK Gas & electricity business guides"
      titleTemplate="%s - Utility Switchboard"
      slug="gas-electricity/guides/business"
   />
)
