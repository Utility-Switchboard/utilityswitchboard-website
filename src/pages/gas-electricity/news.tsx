               ...
               <a className="guide-card-container" href={`/${page.slug}`}>
                  ...
                  <div className="guide-card-content">
                     <span>
                        ...
                        <span className="guide-card-category">Gas & Electricity</span>
                     </span>
      ...
      <React.Fragment>
         ...
         <div className="content-hero-outer-container">
            <div className="content-hero-inner-container container-width">
               <span>
                  <h1>News stories<br/><span>Gas & Electricity</span></h1>

                  <p>Make sure you're full up to date by reading up about all the latest stories in the world of Gas & Electricity.</p>
         ...
         <div className="content-outer-container">
            <div className="content-inner-container container-width">
               <div className="content-container">
                  <Breadcrumbs location="gas-electricity/news"/>
...
export const Head: HeadFC = () => (
   <SEO
      metaDescription="Make sure you're full up to date by reading up about all the latest stories in the world of Gas & Electricity."
      title="UK Gas & Electricity news stories"
      titleTemplate="%s - Utility Switchboard"
      slug="gas-electricity/news"
   />
)
