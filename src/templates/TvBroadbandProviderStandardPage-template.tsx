...
interface pageProps {
   contentfulTvBroadbandProviderStandardPage: {
      slug: string,
      title: string,
      category: string,
      updatedAt: string,
...
const TvBroadbandProviderStandardPageTemplate = ({ data }: { data: pageProps }) => {
   const page = data.contentfulTvBroadbandProviderStandardPage;
...
export default TvBroadbandProviderStandardPageTemplate

export const pageQuery = graphql`
   query pageBySlug( $slug: String!, $provider: String! ) {
      contentfulTvBroadbandProviderStandardPage ( slug: { eq: $slug } ) {
         metaDescription {
            internal {
               content
            }
      ...
      allContentfulTvBroadbandProviderStandardPage ( filter: { slug: { ne: $slug }, provider: { eq: $provider } } ) {
         edges {
            node {
               slug,
               category
