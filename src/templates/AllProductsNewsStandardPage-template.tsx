...
interface pageProps {
   contentfulAllProductsNewsStandardPage: {
      title: string,
      slug: string,
      category: string,
      updatedAt: string,
...
const AllProductsNewsStandardPageTemplate = ({ data }: { data: pageProps }) => {
   const page = data.contentfulAllProductsNewsStandardPage;
   const related_pages = data.allContentfulAllProductsNewsStandardPage.edges
...
export default AllProductsNewsStandardPageTemplate

export const pageQuery = graphql`
   query pageBySlug ( $slug: String!, $category: String! ) {
      contentfulAllProductsNewsStandardPage ( slug: { eq: $slug } ) {
         metaDescription {
            internal {
               content
            }
