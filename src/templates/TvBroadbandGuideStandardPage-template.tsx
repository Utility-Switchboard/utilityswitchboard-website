...
interface pageProps {
   contentfulTvBroadbandGuideStandardPage: {
      title: string,
      slug: string,
      category: string,
      updatedAt: string,
...
const TvBroadbandGuideStandardPageTemplate = ({ data }: { data: pageProps }) => {
   const page = data.contentfulTvBroadbandGuideStandardPage;
   const related_pages = data.allContentfulTvBroadbandGuideStandardPage.edges
...
export default TvBroadbandGuideStandardPageTemplate

export const pageQuery = graphql`
   query pageBySlug ( $slug: String!, $category: String! ) {
      contentfulTvBroadbandGuideStandardPage ( slug: { eq: $slug } ) {
         metaDescription {
            internal {
               content
            }
