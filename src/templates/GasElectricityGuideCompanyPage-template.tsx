...
interface pageProps {
   contentfulGasElectricityGuideCompanyPage: {
      slug: string,
      title: string,
      category: string,
      updatedAt: string,
...
const GasElectricityGuideCompanyPageTemplate = ({ data }: { data: pageProps }) => {
   const page = data.contentfulGasElectricityGuideCompanyPage;
...
export default GasElectricityGuideCompanyPageTemplate

export const pageQuery = graphql`
   query pageBySlug( $slug: String! ) {
      contentfulGasElectricityGuideCompanyPage ( slug: { eq: $slug } ) {
         metaDescription {
            internal {
               content
            }
